...
const noteStub = ()=>{
    return [[{title:'test1',description:"oiuy",score:1,status:{},contact:{}},
    {title:'test2',description:"oiuy234",score:0,status:{},contact:{}},
    {title:'test3',description:"oiuy2345",score:null,status:{},contact:{}}],3]
}
...
describe('noteService',()=>{
    ...
    describe('readAllByContactId',()=>{
        ...
        const expectedResult = {
            notes:[{title:'test1',description:"oiuy",score:1,status:{},contact:{}},
            {title:'test2',description:"oiuy234",score:0,status:{},contact:{}},
            {title:'test3',description:"oiuy2345",score:null,status:{},contact:{}}],
            metadata:{
                total:3,
                size:3,
                page:1
        ...
        expect(await noteService.readAllByContactId({id:1,page:1,size:3})).toEqual(expectedResult)

        })
    });
    it('should return empty list and total number equals zero if contact does not have any notes',async()=>{
        const mockedResult = [[],0];
        const expectedResult = {notes:[],metadata:{ total:0,
            size:3,
            page:1}}
