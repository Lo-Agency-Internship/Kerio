			...
			<div className="flex justify-start align-item item-center w-11/12 ">
				<div className="m-8 py-1 px-1">
					<button
						...
						className="w-32 bg-white tracking-wide text-gray-800 font-bold rounded border-b-2 border-solid border-2 border-gray-600 hover:border-gray-600 hover:bg-gray-800 hover:text-white shadow-md py-2 px-6 inline-flex items-center">
